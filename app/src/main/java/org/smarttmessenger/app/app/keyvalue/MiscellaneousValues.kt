...
class MiscellaneousValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  /**
   * The last time we ran an account consistency check via [com.smarttmessenger.app.jobs.AccountConsistencyWorkerJob]
   */
  ...
  /**
   * The last time we prompted the user regarding a [com.smarttmessenger.app.util.ConnectivityWarning].
   */
