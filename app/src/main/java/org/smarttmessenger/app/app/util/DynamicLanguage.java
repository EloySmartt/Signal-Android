...
import com.smarttmessenger.app.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link com.smarttmessenger.app.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
