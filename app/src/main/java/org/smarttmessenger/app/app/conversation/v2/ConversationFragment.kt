...
import com.smarttmessenger.app.BlockUnblockDialog
import com.smarttmessenger.app.GroupMembersDialog
import com.smarttmessenger.app.LoggingFragment
import com.smarttmessenger.app.MainActivity
import com.smarttmessenger.app.MuteDialog
import com.smarttmessenger.app.R
import com.smarttmessenger.app.audio.AudioRecorder
import com.smarttmessenger.app.badges.gifts.OpenableGift
import com.smarttmessenger.app.badges.gifts.OpenableGiftItemDecoration
import com.smarttmessenger.app.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import com.smarttmessenger.app.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import com.smarttmessenger.app.banner.banners.ServiceOutageBanner
import com.smarttmessenger.app.banner.banners.UnauthorizedBanner
import com.smarttmessenger.app.components.AnimatingToggle
import com.smarttmessenger.app.components.ComposeText
import com.smarttmessenger.app.components.ConversationSearchBottomBar
import com.smarttmessenger.app.components.DeleteSyncEducationDialog
import com.smarttmessenger.app.components.HidingLinearLayout
import com.smarttmessenger.app.components.InputAwareConstraintLayout
import com.smarttmessenger.app.components.InputPanel
import com.smarttmessenger.app.components.InsetAwareConstraintLayout
import com.smarttmessenger.app.components.ProgressCardDialogFragment
import com.smarttmessenger.app.components.ProgressCardDialogFragmentArgs
import com.smarttmessenger.app.components.ScrollToPositionDelegate
import com.smarttmessenger.app.components.SendButton
...
import com.smarttmessenger.app.components.emoji.MediaKeyboard
import com.smarttmessenger.app.components.emoji.RecentEmojiPageModel
import com.smarttmessenger.app.components.location.SignalPlace
...
import com.smarttmessenger.app.components.menu.SignalBottomActionBar
import com.smarttmessenger.app.components.settings.app.subscription.donate.CheckoutFlowActivity
import com.smarttmessenger.app.components.settings.app.subscription.donate.DonateToSignalFragment
import com.smarttmessenger.app.components.settings.conversation.ConversationSettingsActivity
import com.smarttmessenger.app.components.spoiler.SpoilerAnnotation
import com.smarttmessenger.app.components.voice.VoiceNoteDraft
import com.smarttmessenger.app.components.voice.VoiceNoteMediaControllerOwner
import com.smarttmessenger.app.components.voice.VoiceNotePlaybackState
import com.smarttmessenger.app.components.voice.VoiceNotePlayerView
import com.smarttmessenger.app.contacts.paged.ContactSearchKey.RecipientSearchKey
import com.smarttmessenger.app.contactshare.Contact
import com.smarttmessenger.app.contactshare.ContactUtil
import com.smarttmessenger.app.contactshare.SharedContactDetailsActivity
import com.smarttmessenger.app.conversation.AttachmentKeyboardButton
import com.smarttmessenger.app.conversation.BadDecryptLearnMoreDialog
import com.smarttmessenger.app.conversation.ConversationAdapter
import com.smarttmessenger.app.conversation.ConversationBottomSheetCallback
import com.smarttmessenger.app.conversation.ConversationData
import com.smarttmessenger.app.conversation.ConversationHeaderView
import com.smarttmessenger.app.conversation.ConversationIntents
import com.smarttmessenger.app.conversation.ConversationIntents.ConversationScreenType
import com.smarttmessenger.app.conversation.ConversationItem
import com.smarttmessenger.app.conversation.ConversationItemSelection
import com.smarttmessenger.app.conversation.ConversationItemSwipeCallback
import com.smarttmessenger.app.conversation.ConversationMessage
import com.smarttmessenger.app.conversation.ConversationOptionsMenu
import com.smarttmessenger.app.conversation.ConversationReactionDelegate
import com.smarttmessenger.app.conversation.ConversationReactionOverlay
import com.smarttmessenger.app.conversation.ConversationReactionOverlay.OnActionSelectedListener
import com.smarttmessenger.app.conversation.ConversationReactionOverlay.OnHideListener
import com.smarttmessenger.app.conversation.ConversationSearchViewModel
import com.smarttmessenger.app.conversation.ConversationUpdateTick
import com.smarttmessenger.app.conversation.MarkReadHelper
import com.smarttmessenger.app.conversation.MenuState
import com.smarttmessenger.app.conversation.MessageSendType
import com.smarttmessenger.app.conversation.MessageStyler.getStyling
import com.smarttmessenger.app.conversation.ReenableScheduledMessagesDialogFragment
import com.smarttmessenger.app.conversation.ScheduleMessageContextMenu
import com.smarttmessenger.app.conversation.ScheduleMessageDialogCallback
import com.smarttmessenger.app.conversation.ScheduleMessageTimePickerBottomSheet
import com.smarttmessenger.app.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import com.smarttmessenger.app.conversation.ScheduledMessagesBottomSheet
import com.smarttmessenger.app.conversation.ScheduledMessagesRepository
import com.smarttmessenger.app.conversation.SelectedConversationModel
import com.smarttmessenger.app.conversation.ShowAdminsBottomSheetDialog
...
import com.smarttmessenger.app.conversation.drafts.DraftRepository
import com.smarttmessenger.app.conversation.drafts.DraftRepository.ShareOrDraftData
import com.smarttmessenger.app.conversation.drafts.DraftViewModel
import com.smarttmessenger.app.conversation.mutiselect.ConversationItemAnimator
import com.smarttmessenger.app.conversation.mutiselect.MultiselectItemDecoration
import com.smarttmessenger.app.conversation.mutiselect.MultiselectPart
import com.smarttmessenger.app.conversation.mutiselect.forward.MultiselectForwardBottomSheet
import com.smarttmessenger.app.conversation.mutiselect.forward.MultiselectForwardFragment
import com.smarttmessenger.app.conversation.mutiselect.forward.MultiselectForwardFragmentArgs
import com.smarttmessenger.app.conversation.quotes.MessageQuotesBottomSheet
import com.smarttmessenger.app.conversation.ui.edit.EditMessageHistoryDialog
import com.smarttmessenger.app.conversation.ui.error.EnableCallNotificationSettingsDialog
import com.smarttmessenger.app.conversation.ui.inlinequery.InlineQuery
import com.smarttmessenger.app.conversation.ui.inlinequery.InlineQueryChangedListener
import com.smarttmessenger.app.conversation.ui.inlinequery.InlineQueryReplacement
import com.smarttmessenger.app.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import com.smarttmessenger.app.conversation.ui.inlinequery.InlineQueryViewModelV2
import com.smarttmessenger.app.conversation.v2.computed.ConversationMessageComputeWorkers
import com.smarttmessenger.app.conversation.v2.data.ConversationMessageElement
import com.smarttmessenger.app.conversation.v2.groups.ConversationGroupCallViewModel
import com.smarttmessenger.app.conversation.v2.groups.ConversationGroupViewModel
import com.smarttmessenger.app.conversation.v2.items.ChatColorsDrawable
import com.smarttmessenger.app.conversation.v2.items.InteractiveConversationElement
import com.smarttmessenger.app.conversation.v2.keyboard.AttachmentKeyboardFragment
import com.smarttmessenger.app.database.AttachmentTable
import com.smarttmessenger.app.database.DraftTable
...
import com.smarttmessenger.app.databinding.V2ConversationFragmentBinding
import com.smarttmessenger.app.dependencies.AppDependencies
import com.smarttmessenger.app.events.GroupCallPeekEvent
import com.smarttmessenger.app.giph.mp4.GiphyMp4ItemDecoration
import com.smarttmessenger.app.giph.mp4.GiphyMp4PlaybackController
import com.smarttmessenger.app.giph.mp4.GiphyMp4PlaybackPolicy
import com.smarttmessenger.app.giph.mp4.GiphyMp4ProjectionPlayerHolder
import com.smarttmessenger.app.giph.mp4.GiphyMp4ProjectionRecycler
...
import com.smarttmessenger.app.groups.ui.LeaveGroupDialog
import com.smarttmessenger.app.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import com.smarttmessenger.app.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import com.smarttmessenger.app.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import com.smarttmessenger.app.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import com.smarttmessenger.app.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
import com.smarttmessenger.app.groups.v2.GroupBlockJoinRequestResult
import com.smarttmessenger.app.invites.InviteActions
import com.smarttmessenger.app.jobs.ServiceOutageDetectionJob
import com.smarttmessenger.app.keyboard.KeyboardPage
import com.smarttmessenger.app.keyboard.KeyboardPagerFragment
import com.smarttmessenger.app.keyboard.KeyboardPagerViewModel
import com.smarttmessenger.app.keyboard.KeyboardUtil
import com.smarttmessenger.app.keyboard.emoji.EmojiKeyboardPageFragment
import com.smarttmessenger.app.keyboard.emoji.search.EmojiSearchFragment
import com.smarttmessenger.app.keyboard.gif.GifKeyboardPageFragment
import com.smarttmessenger.app.keyboard.sticker.StickerKeyboardPageFragment
import com.smarttmessenger.app.keyboard.sticker.StickerSearchDialogFragment
import com.smarttmessenger.app.keyvalue.SignalStore
import com.smarttmessenger.app.linkpreview.LinkPreview
import com.smarttmessenger.app.linkpreview.LinkPreviewViewModelV2
import com.smarttmessenger.app.longmessage.LongMessageFragment
import com.smarttmessenger.app.mediaoverview.MediaOverviewActivity
import com.smarttmessenger.app.mediapreview.MediaIntentFactory
import com.smarttmessenger.app.mediapreview.MediaPreviewV2Activity
import com.smarttmessenger.app.mediasend.Media
import com.smarttmessenger.app.mediasend.MediaSendActivityResult
import com.smarttmessenger.app.messagedetails.MessageDetailsFragment
import com.smarttmessenger.app.messagerequests.MessageRequestRepository
import com.smarttmessenger.app.mms.AttachmentManager
import com.smarttmessenger.app.mms.AudioSlide
import com.smarttmessenger.app.mms.DocumentSlide
import com.smarttmessenger.app.mms.GifSlide
import com.smarttmessenger.app.mms.ImageSlide
...
import com.smarttmessenger.app.mms.SlideFactory
import com.smarttmessenger.app.mms.StickerSlide
import com.smarttmessenger.app.mms.VideoSlide
import com.smarttmessenger.app.nicknames.NicknameActivity
import com.smarttmessenger.app.notifications.v2.ConversationId
import com.smarttmessenger.app.payments.preferences.PaymentsActivity
import com.smarttmessenger.app.permissions.Permissions
import com.smarttmessenger.app.profiles.manage.EditProfileActivity
import com.smarttmessenger.app.profiles.spoofing.ReviewCardDialogFragment
import com.smarttmessenger.app.providers.BlobProvider
import com.smarttmessenger.app.ratelimit.RecaptchaProofBottomSheetFragment
import com.smarttmessenger.app.ratelimit.RecaptchaRequiredEvent
import com.smarttmessenger.app.reactions.ReactionsBottomSheetDialogFragment
import com.smarttmessenger.app.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment
import com.smarttmessenger.app.recipients.Recipient
import com.smarttmessenger.app.recipients.RecipientExporter
...
import com.smarttmessenger.app.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import com.smarttmessenger.app.registration.ui.RegistrationActivity
import com.smarttmessenger.app.revealable.ViewOnceMessageActivity
import com.smarttmessenger.app.revealable.ViewOnceUtil
import com.smarttmessenger.app.safety.SafetyNumberBottomSheet
import com.smarttmessenger.app.sms.MessageSender
import com.smarttmessenger.app.stickers.StickerEventListener
import com.smarttmessenger.app.stickers.StickerLocator
import com.smarttmessenger.app.stickers.StickerManagementActivity
import com.smarttmessenger.app.stickers.StickerPackInstallEvent
import com.smarttmessenger.app.stickers.StickerPackPreviewActivity
import com.smarttmessenger.app.stories.StoryViewerArgs
import com.smarttmessenger.app.stories.viewer.StoryViewerActivity
import com.smarttmessenger.app.util.BottomSheetUtil
import com.smarttmessenger.app.util.BubbleUtil
...
import com.smarttmessenger.app.util.DateUtils
import com.smarttmessenger.app.util.Debouncer
import com.smarttmessenger.app.util.DeleteDialog
import com.smarttmessenger.app.util.Dialogs
import com.smarttmessenger.app.util.DoubleClickDebouncer
import com.smarttmessenger.app.util.DrawableUtil
import com.smarttmessenger.app.util.FullscreenHelper
import com.smarttmessenger.app.util.MediaUtil
import com.smarttmessenger.app.util.MessageConstraintsUtil
import com.smarttmessenger.app.util.MessageConstraintsUtil.getEditMessageThresholdHours
import com.smarttmessenger.app.util.MessageConstraintsUtil.isValidEditMessageSend
import com.smarttmessenger.app.util.PlayStoreUtil
import com.smarttmessenger.app.util.RemoteConfig
import com.smarttmessenger.app.util.SaveAttachmentUtil
import com.smarttmessenger.app.util.SharedPreferencesLifecycleObserver
import com.smarttmessenger.app.util.SignalLocalMetrics
import com.smarttmessenger.app.util.StorageUtil
import com.smarttmessenger.app.util.TextSecurePreferences
import com.smarttmessenger.app.util.ViewUtil
import com.smarttmessenger.app.util.WindowUtil
import com.smarttmessenger.app.util.atMidnight
import com.smarttmessenger.app.util.atUTC
import com.smarttmessenger.app.util.createActivityViewModel
import com.smarttmessenger.app.util.doAfterNextLayout
import com.smarttmessenger.app.util.fragments.requireListener
import com.smarttmessenger.app.util.getRecordQuoteType
import com.smarttmessenger.app.util.hasAudio
import com.smarttmessenger.app.util.hasGiftBadge
import com.smarttmessenger.app.util.hasNonTextSlide
import com.smarttmessenger.app.util.isValidReactionTarget
import com.smarttmessenger.app.util.padding
import com.smarttmessenger.app.util.savedStateViewModel
import com.smarttmessenger.app.util.setIncognitoKeyboardEnabled
import com.smarttmessenger.app.util.toMillis
import com.smarttmessenger.app.util.viewModel
import com.smarttmessenger.app.util.views.Stub
import com.smarttmessenger.app.util.visible
import com.smarttmessenger.app.verify.VerifyIdentityActivity
import com.smarttmessenger.app.wallpaper.ChatWallpaper
import com.smarttmessenger.app.wallpaper.ChatWallpaperDimLevelUtil
