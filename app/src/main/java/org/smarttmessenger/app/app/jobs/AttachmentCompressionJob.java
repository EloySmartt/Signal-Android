...
import com.smarttmessenger.app.jobmanager.persistence.JobSpec;
import com.smarttmessenger.app.mms.DecryptableStreamUriLoader;
import com.smarttmessenger.app.mms.MediaConstraints;
import com.smarttmessenger.app.mms.MediaStream;
import com.smarttmessenger.app.mms.MmsException;
import com.smarttmessenger.app.mms.SentMediaQuality;
import com.smarttmessenger.app.service.AttachmentProgressService;
import com.smarttmessenger.app.transport.UndeliverableMessageException;
import com.smarttmessenger.app.util.BitmapDecodingException;
import com.smarttmessenger.app.util.ImageCompressionUtil;
import com.smarttmessenger.app.util.MediaUtil;
import com.smarttmessenger.app.util.MemoryFileDescriptor.MemoryFileException;
import com.smarttmessenger.app.util.RemoteConfig;
import com.smarttmessenger.app.video.StreamingTranscoder;
import com.smarttmessenger.app.video.TranscoderOptions;
import com.smarttmessenger.app.video.exceptions.VideoPostProcessingException;
import com.smarttmessenger.app.video.exceptions.VideoSourceException;
import com.smarttmessenger.app.video.interfaces.TranscoderCancelationSignal;
import com.smarttmessenger.app.video.postprocessing.Mp4FaststartPostProcessor;
import com.smarttmessenger.app.video.videoconverter.exceptions.EncodingException;
