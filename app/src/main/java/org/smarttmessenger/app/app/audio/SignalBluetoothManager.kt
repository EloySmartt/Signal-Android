...
package com.smarttmessenger.app.audio
...
import com.smarttmessenger.app.util.safeUnregisterReceiver
import com.smarttmessenger.app.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [com.smarttmessenger.app.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [com.smarttmessenger.app.webrtc.audio.SignalAudioManager].
 */
