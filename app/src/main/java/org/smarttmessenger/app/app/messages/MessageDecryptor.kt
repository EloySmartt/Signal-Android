...
import com.smarttmessenger.app.jobs.SendRetryReceiptJob
import com.smarttmessenger.app.keyvalue.SignalStore
import com.smarttmessenger.app.logsubmit.SubmitDebugLogActivity
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [com.smarttmessenger.app.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
