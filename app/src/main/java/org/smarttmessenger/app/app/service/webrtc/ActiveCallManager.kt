...
import com.smarttmessenger.app.service.SafeForegroundService
import com.smarttmessenger.app.util.TelephonyUtil
import com.smarttmessenger.app.webrtc.CallNotificationBuilder
import com.smarttmessenger.app.webrtc.UncaughtExceptionHandlerManager
import com.smarttmessenger.app.webrtc.audio.AudioManagerCommand
import com.smarttmessenger.app.webrtc.audio.SignalAudioManager
import com.smarttmessenger.app.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "com.smarttmessenger.app.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "com.smarttmessenger.app.service.webrtc.ActiveCallAction.HANGUP"
    }
