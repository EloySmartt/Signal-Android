...
import com.smarttmessenger.app.attachments.ArchivedAttachment
...
import com.smarttmessenger.app.backup.v2.proto.BodyRange
...
import com.smarttmessenger.app.backup.v2.proto.LinkPreview
...
import com.smarttmessenger.app.database.SQLiteDatabase
...
import com.smarttmessenger.app.database.model.databaseprotos.CryptoValue
...
import com.smarttmessenger.app.database.model.databaseprotos.PaymentTombstone
...
import com.smarttmessenger.app.payments.CryptoValueUtil
import com.smarttmessenger.app.payments.Direction
...
class ChatItemImportInserter(
  ...
  private fun LinkPreview.toLocalLinkPreview(): com.smarttmessenger.app.linkpreview.LinkPreview {
    return com.smarttmessenger.app.linkpreview.LinkPreview(
      this.url,
      this.title ?: "",
      this.description ?: "",
      this.date ?: 0,
