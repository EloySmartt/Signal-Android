...
import com.smarttmessenger.app.ShortcutLauncherActivity
...
import com.smarttmessenger.app.components.emoji.EmojiStrings
...
import com.smarttmessenger.app.conversation.v2.RequestReviewState.GroupReviewState
import com.smarttmessenger.app.conversation.v2.RequestReviewState.IndividualReviewState
import com.smarttmessenger.app.conversation.v2.data.ConversationDataSource
...
import com.smarttmessenger.app.jobs.MultiDeviceViewOnceOpenJob
import com.smarttmessenger.app.keyboard.KeyboardUtil
import com.smarttmessenger.app.linkpreview.LinkPreview
import com.smarttmessenger.app.messagerequests.MessageRequestState
...
import com.smarttmessenger.app.profiles.spoofing.ReviewRecipient
...
import com.smarttmessenger.app.sms.MessageSender.PreUploadResult
import com.smarttmessenger.app.util.DrawableUtil
import com.smarttmessenger.app.util.MediaUtil
import com.smarttmessenger.app.util.MessageUtil
import com.smarttmessenger.app.util.SignalLocalMetrics
import com.smarttmessenger.app.util.Util
import com.smarttmessenger.app.util.hasLinkPreview
import com.smarttmessenger.app.util.hasSharedContact
import com.smarttmessenger.app.util.hasTextSlide
import com.smarttmessenger.app.util.isViewOnceMessage
import com.smarttmessenger.app.util.requireTextSlide
...
class ConversationRepository(
  ...
  private val oldConversationRepository = com.smarttmessenger.app.conversation.ConversationRepository()
