...
import com.smarttmessenger.app.backup.v2.BackupRepository.getMediaName
import com.smarttmessenger.app.backup.v2.proto.ChatItem
import com.smarttmessenger.app.backup.v2.proto.ChatUpdateMessage
import com.smarttmessenger.app.backup.v2.proto.ContactAttachment
import com.smarttmessenger.app.backup.v2.proto.ContactMessage
import com.smarttmessenger.app.backup.v2.proto.ExpirationTimerChatUpdate
import com.smarttmessenger.app.backup.v2.proto.FilePointer
import com.smarttmessenger.app.backup.v2.proto.GroupCall
import com.smarttmessenger.app.backup.v2.proto.IndividualCall
import com.smarttmessenger.app.backup.v2.proto.LearnedProfileChatUpdate
import com.smarttmessenger.app.backup.v2.proto.MessageAttachment
import com.smarttmessenger.app.backup.v2.proto.PaymentNotification
import com.smarttmessenger.app.backup.v2.proto.ProfileChangeChatUpdate
import com.smarttmessenger.app.backup.v2.proto.Quote
import com.smarttmessenger.app.backup.v2.proto.Reaction
import com.smarttmessenger.app.backup.v2.proto.RemoteDeletedMessage
import com.smarttmessenger.app.backup.v2.proto.SendStatus
import com.smarttmessenger.app.backup.v2.proto.SessionSwitchoverChatUpdate
import com.smarttmessenger.app.backup.v2.proto.SimpleChatUpdate
import com.smarttmessenger.app.backup.v2.proto.StandardMessage
import com.smarttmessenger.app.backup.v2.proto.Sticker
import com.smarttmessenger.app.backup.v2.proto.StickerMessage
import com.smarttmessenger.app.backup.v2.proto.Text
import com.smarttmessenger.app.backup.v2.proto.ThreadMergeChatUpdate
...
import com.smarttmessenger.app.database.model.GroupsV2UpdateMessageConverter
...
import com.smarttmessenger.app.payments.FailureReason
import com.smarttmessenger.app.payments.State
...
import com.smarttmessenger.app.backup.v2.proto.BodyRange as BackupBodyRange
import com.smarttmessenger.app.backup.v2.proto.GiftBadge as BackupGiftBadge
...
class ChatItemExportIterator(private val cursor: Cursor, private val batchSize: Int, private val archiveMedia: Boolean) : Iterator<ChatItem?>, Closeable {
  ...
  private fun LinkPreview.toBackupLinkPreview(): com.smarttmessenger.app.backup.v2.proto.LinkPreview {
    return com.smarttmessenger.app.backup.v2.proto.LinkPreview(
      url = url,
      title = title,
