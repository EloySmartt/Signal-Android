...
class ProxySQLCipherOpenHelper(
  ...
  override val signalReadableDatabase: com.smarttmessenger.app.database.SQLiteDatabase
    get() = ProxySignalSQLiteDatabase(readableDatabase)

  override val signalWritableDatabase: com.smarttmessenger.app.database.SQLiteDatabase
