  ...
  override fun onCreate() {
    ...
    LeakCanary.config = LeakCanary.config.copy(
      referenceMatchers = AndroidReferenceMatchers.appDefaults +
        ...
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "com.smarttmessenger.app.components.voice.VoiceNotePlaybackService",
          fieldName = "mApplication"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "com.smarttmessenger.app.service.GenericForegroundService\$LocalBinder",
          fieldName = "this\$0"
        ) +
        AndroidReferenceMatchers.ignoredInstanceField(
          className = "com.smarttmessenger.app.contacts.ContactsSyncAdapter",
          fieldName = "mContext"
        )
    )
  }
